...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="height: 500px; width: 1250px; background: #cc6fb0">
        <div>
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Inciar Sesión</a>
            ...
            <header class="container">
                <div class="row" >
                    <div class="col-12 align-self-center text-center">
                        <img src="{{asset('img/libro.jpg')}}" class="img-fliud mt-4" width="450"  alt="450">
                            <h1 class="mt-4">"Un libro es un sueño que tienes en tus manos"</h1>
                            <h4>Neil Geiman</h4>
                    </div>
                </div>
            </header>
